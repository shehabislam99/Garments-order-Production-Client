  ...
  return (
    <div className="mx-auto min-h-screen px-4 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden ">
        <div className="mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 custom-bg p-6 rounded-4xl shadow-xl">
      ...
      <div className="mx-auto px-2 py-20 lg:px-6">
